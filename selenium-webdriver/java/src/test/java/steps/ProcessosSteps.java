...
public class ProcessosSteps extends BaseSteps {
    ...
    public void oUsuarioClicarNoBotaoAlterar() {
        processosMostrar.clicarAlterar();
    }

    @E("^o usuario clicar no botao deletar do usuario com id \"([^\"]*)\"$")
    public void oUsuarioClicarNoBotaoDeletarComOId(String id) throws Throwable {
        gridProcessos.deletarElemento(id);
    }

    @E("^o usuario clicar no botao mostrar do usuario com o id \"(.*)\"$")
    public void oUsuarioClicarNoBotaoMostrarDoUsuarioComOId(String id) throws Throwable {
        processosMostrar.clicarMostrar(id);
    }
}
